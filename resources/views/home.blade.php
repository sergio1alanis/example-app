...
@section('content')
<div class="bg-gray-900 px-20 py-16 rounded-lg mb-8 realtive overflow-hidden">
    <span class="text-xs uppercase text-gray-700 bg-gray-400 rounded-full px-2 py-1">Progrmación</span>
    <h1 class="text-3xl text-white mt-4">Blog</h1>
    <p class="text-sm text-gray-400 mt-2">Este es el blog de programación</p>
